 ...
 * (GenCodeChecksum:a75557b12bebad1ce86589e1cf2cc7b3)
 */
...
class CRM_Funding_DAO_FundingCaseType extends CRM_Core_DAO {
   ...
   *   Note that values will be retrieved from the database as a string.
   */
  public $is_summary_application;

  /**
   * Used for summary applications
   *
   * @var string|null
   *   (SQL type: varchar(255))
   *   Note that values will be retrieved from the database as a string.
  ...
  public static function &fields() {
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'is_summary_application' => [
          'name' => 'is_summary_application',
          ...
          'where' => 'civicrm_funding_case_type.is_summary_application',
          'table_name' => 'civicrm_funding_case_type',
          'entity' => 'FundingCaseType',
          'bao' => 'CRM_Funding_DAO_FundingCaseType',
          'localizable' => 0,
        ...
        'application_process_label' => [
          ...
          'description' => E::ts('Used for summary applications'),
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
          'usage' => [
            'import' => FALSE,
