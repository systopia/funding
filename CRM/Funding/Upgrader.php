...
final class CRM_Funding_Upgrader extends CRM_Extension_Upgrader_Base {
  ...
  public function upgrade_0015(): bool {
    $this->ctx->log->info('Applying database migration 0015');
    $this->executeSqlFile('sql/upgrade/0015.sql');

    return TRUE;
  }

  public function upgrade_0016(): bool {
    $this->ctx->log->info('Applying database migration 0016');
    $this->executeSqlFile('sql/upgrade/0016.sql');
  ...
  public function upgrade_0018(): bool {
    $this->ctx->log->info('Applying database migration 0018');
    $this->executeSqlFile('sql/upgrade/0018.sql');
