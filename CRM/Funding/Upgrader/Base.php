 ...
 */
class CRM_Funding_Upgrader_Base {

  /**
   * @var CRM_Funding_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Funding_Upgrader(
        'funding',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Funding_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Funding_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
