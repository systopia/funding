...
use Civi\Funding\Api4\Action\FundingApplicationResourcesItem\GetFieldsAction;
use Civi\Funding\Api4\Action\Generic\FinancePlanItem\GetAction;
use Civi\Funding\Api4\Traits\AccessPermissionsTrait;

/**
 * ApplicationResourcesItem entity.
 *
 * Provided by the Funding Program Manager extension.
 *
 * @package Civi\Api4
 */
final class FundingApplicationResourcesItem extends Generic\DAOEntity {
