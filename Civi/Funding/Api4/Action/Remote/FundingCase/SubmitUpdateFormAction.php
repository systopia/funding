...
final class SubmitUpdateFormAction extends AbstractRemoteFundingAction {
  ...
  public function __construct(ActionHandlerInterface $actionHandler = NULL) {
    parent::__construct(RemoteFundingCase::getEntityName(), 'submitUpdateForm', $actionHandler);
  }
