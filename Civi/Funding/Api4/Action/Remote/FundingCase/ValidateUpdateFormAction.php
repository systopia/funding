...
final class ValidateUpdateFormAction extends AbstractRemoteFundingAction {
  ...
  public function __construct(?ActionHandlerInterface $actionHandler = NULL) {
    parent::__construct(RemoteFundingCase::getEntityName(), 'validateUpdateForm', $actionHandler);
  }
