...
class ClearingGroupExtractor {
   ...
   * (there's only one in that case) shall not be in any group in the clearing
   * form. The order depends on the order of the controls in the UI schema, not
   * on the order of the given scopes.
   *
