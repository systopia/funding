...
final class ApplicationCostItemsAddIdentifiersHandler implements ApplicationCostItemsAddIdentifiersHandlerInterface {

  private ApplicationCostItemsFactoryInterface $costItemsFactory;

  public function __construct(ApplicationCostItemsFactoryInterface $costItemsFactory) {
  ...
  public function handle(ApplicationCostItemsAddIdentifiersCommand $command): array {
    return $this->costItemsFactory->addIdentifiers($command->getRequestData());
  }
