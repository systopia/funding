...
interface ApplicationFilesPersistHandlerInterface {

  public const SERVICE_TAG = 'funding.application.files_persist_handler';

  /**
   * @phpstan-return array<string, \Civi\Funding\Entity\ExternalFileEntity>
   *   Mapping of URI from request to external file.
   */
