...
final class ApplicationSnapshotCreateHandler implements ApplicationSnapshotCreateHandlerInterface {
  ...
  public function handle(ApplicationSnapshotCreateCommand $command): void {
    ...
    $applicationSnapshot = ApplicationSnapshotEntity::fromArray([
      ...
      'first_application_date' => DateTimeUtil::toDateTimeStrOrNull($applicationProcess->getFirstApplicationDate()),
      'first_application_contact_id' => $applicationProcess->getFirstApplicationContactId(),
      'last_application_date' => DateTimeUtil::toDateTimeStrOrNull($applicationProcess->getLastApplicationDate()),
      'last_application_contact_id' => $applicationProcess->getLastApplicationContactId(),
