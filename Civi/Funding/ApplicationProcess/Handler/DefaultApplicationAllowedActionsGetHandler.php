 ...
 * @codeCoverageIgnore
 */
final class DefaultApplicationAllowedActionsGetHandler implements ApplicationAllowedActionsGetHandlerInterface {
  ...
  public function handle(ApplicationAllowedActionsGetCommand $command): array {
    return $this->serviceLocatorContainer->get($command->getFundingCaseType()->getName())
      ->getApplicationAllowedActionsGetHandler()->handle($command);
  }
