 ...
 * @codeCoverageIgnore
 */
final class DefaultApplicationCostItemsAddIdentifiersHandler implements ApplicationCostItemsAddIdentifiersHandlerInterface {
// phpcs:enable
  ...
  public function handle(ApplicationCostItemsAddIdentifiersCommand $command): array {
    return $this->serviceLocatorContainer->get($command->getFundingCaseType()->getName())
      ->getApplicationCostItemsAddIdentifiersHandler()->handle($command);
  }
