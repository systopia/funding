 ...
 * @codeCoverageIgnore
 */
final class DefaultApplicationFilesAddIdentifiersHandler implements ApplicationFilesAddIdentifiersHandlerInterface {
  ...
  public function handle(ApplicationFilesAddIdentifiersCommand $command): array {
    return $this->serviceLocatorContainer->get($command->getFundingCaseType()->getName())
      ->getApplicationFilesAddIdentifiersHandler()->handle($command);
  }
