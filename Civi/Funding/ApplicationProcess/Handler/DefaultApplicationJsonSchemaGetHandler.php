 ...
 * @codeCoverageIgnore
 */
final class DefaultApplicationJsonSchemaGetHandler implements ApplicationJsonSchemaGetHandlerInterface {
  ...
  public function handle(ApplicationJsonSchemaGetCommand $command): JsonSchema {
    return $this->serviceLocatorContainer->get($command->getFundingCaseType()->getName())
      ->getApplicationJsonSchemaGetHandler()->handle($command);
  }
