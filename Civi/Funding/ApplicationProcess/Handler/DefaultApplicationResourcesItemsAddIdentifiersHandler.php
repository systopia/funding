 ...
 * @codeCoverageIgnore
 */
final class DefaultApplicationResourcesItemsAddIdentifiersHandler implements ApplicationResourcesItemsAddIdentifiersHandlerInterface {
// phpcs:enable
  ...
  public function handle(ApplicationResourcesItemsAddIdentifiersCommand $command): array {
    return $this->serviceLocatorContainer->get($command->getFundingCaseType()->getName())
      ->getApplicationResourcesItemsAddIdentifiersHandler()->handle($command);
  }
