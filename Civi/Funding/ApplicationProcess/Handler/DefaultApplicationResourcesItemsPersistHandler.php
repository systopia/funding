 ...
 * @codeCoverageIgnore
 */
final class DefaultApplicationResourcesItemsPersistHandler implements ApplicationResourcesItemsPersistHandlerInterface {
  ...
  public function handle(ApplicationResourcesItemsPersistCommand $command): void {
    $this->serviceLocatorContainer->get($command->getFundingCaseType()->getName())
      ->getApplicationResourcesItemsPersistHandler()->handle($command);
  }
