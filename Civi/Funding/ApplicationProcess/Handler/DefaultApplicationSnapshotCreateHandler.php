 ...
 * @codeCoverageIgnore
 */
final class DefaultApplicationSnapshotCreateHandler implements ApplicationSnapshotCreateHandlerInterface {
  ...
  public function handle(ApplicationSnapshotCreateCommand $command): void {
    $this->serviceLocatorContainer->get($command->getFundingCaseType()->getName())
      ->getApplicationSnapshotCreateHandler()->handle($command);
  }
