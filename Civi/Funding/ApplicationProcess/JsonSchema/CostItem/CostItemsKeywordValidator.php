...
final class CostItemsKeywordValidator extends AbstractKeywordValidator {

  use ErrorTrait;

  private ArrayCostItemDataFactory $costItemDataFactory;

  public function __construct(ArrayCostItemDataFactory $costItemDataFactory) {
