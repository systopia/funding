...
/**
 * For the "$costItems" keyword.
 *
 * @see \Civi\Funding\ApplicationProcess\JsonSchema\CostItem\CostItemsKeywordValidator
 *
 * @codeCoverageIgnore
 */
final class JsonSchemaCostItems extends JsonSchema {
