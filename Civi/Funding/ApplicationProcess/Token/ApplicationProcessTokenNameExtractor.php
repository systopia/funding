 ...
 * @codeCoverageIgnore
 */
class ApplicationProcessTokenNameExtractor implements TokenNameExtractorInterface {
  ...
  public function getTokenNames(string $entityName, string $entityClass): array {
    return $this->tokenNameExtractor->getTokenNames($entityName, $entityClass)
      + [
        'first_application_contact_display_name' => E::ts('First Application Contact Display Name'),
        'last_application_contact_display_name' => E::ts('Last Application Contact Display Name'),
      ];
  }
