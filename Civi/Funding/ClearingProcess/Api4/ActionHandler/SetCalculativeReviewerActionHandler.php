...
final class SetCalculativeReviewerActionHandler implements ActionHandlerInterface {
   ...
   */
  public function setCalculativeReviewer(SetCalculativeReviewerAction $action): array {
    ...
    $this->api4->updateEntity(
      ...
      ['reviewer_calc_contact_id' => $action->getReviewerContactId()]
    );
