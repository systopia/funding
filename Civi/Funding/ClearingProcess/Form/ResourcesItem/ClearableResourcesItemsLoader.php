...
/**
 * @extends AbstractClearableItemsLoader<\Civi\Funding\Entity\ApplicationResourcesItemEntity>
 */
final class ClearableResourcesItemsLoader extends AbstractClearableItemsLoader {

  public function __construct(
    ApplicationResourcesItemManager $itemManager,
  ...
  protected function getFinancePlanItemMetaData(
    ...
    return $fundingCaseTypeMetaData->getResourcesItemType($type);
  }
