 ...
 * @codeCoverageIgnore
 */
final class OpisClearingValidatorFactory {

  private static OpisClearingValidator $validator;

  public static function getValidator(): OpisClearingValidator {
    if (!isset(self::$validator)) {
      $expressionHandler = new SymfonyExpressionHandler(new SystopiaExpressionLanguage());
      self::$validator = new OpisClearingValidator([
