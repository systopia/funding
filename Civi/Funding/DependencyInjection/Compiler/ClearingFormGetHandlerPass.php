...
final class ClearingFormGetHandlerPass implements CompilerPassInterface {
  ...
  public function process(ContainerBuilder $container): void {
    $services = $this->getTaggedFundingCaseTypeServices($container, ClearingFormGetHandlerInterface::class);
    $container->register(ClearingFormGetHandlerInterface::class, ClearingFormGetHandlerCollector::class)
