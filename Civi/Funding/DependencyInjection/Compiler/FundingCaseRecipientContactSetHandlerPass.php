...
use Civi\Funding\FundingCase\Handler\FundingCaseRecipientContactSetHandler;
use Civi\Funding\FundingCase\Handler\FundingCaseRecipientContactSetHandlerCollector;
 ...
 * @codeCoverageIgnore
 */
final class FundingCaseRecipientContactSetHandlerPass implements CompilerPassInterface {
  ...
  public function process(ContainerBuilder $container): void {
    ...
    $handlerServices = $this->getTaggedFundingCaseTypeServices(
      $container,
      FundingCaseRecipientContactSetHandlerInterface::SERVICE_TAG
    );
    ...
    foreach (array_diff(
      ...
      $handlerServices[$fundingCaseType] = $this->createFundingCaseTypeService(
        $container,
        $fundingCaseType,
        FundingCaseRecipientContactSetHandler::class,
        ['$actionsDeterminer' => $actionsDeterminerServices[$fundingCaseType]]
      );
    }

    $container->register(
      FundingCaseRecipientContactSetHandlerInterface::class,
      FundingCaseRecipientContactSetHandlerCollector::class
