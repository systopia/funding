...
use Civi\Funding\FundingCase\Handler\FundingCaseRejectHandler;
use Civi\Funding\FundingCase\Handler\FundingCaseRejectHandlerCollector;
 ...
 * @codeCoverageIgnore
 */
final class FundingCaseRejectHandlerPass implements CompilerPassInterface {
  ...
  public function process(ContainerBuilder $container): void {
    $handlerServices = $this->getTaggedFundingCaseTypeServices(
      $container,
      FundingCaseRejectHandlerInterface::class
    );
    $actionsDeterminerServices = $this->getTaggedFundingCaseTypeServices(
      $container,
      FundingCaseActionsDeterminerInterface::SERVICE_TAG
    );
    $applicationProcessStatusDeterminerServices = $this->getTaggedFundingCaseTypeServices(
      $container,
      ApplicationProcessStatusDeterminerInterface::SERVICE_TAG
    );
    ...
    foreach (FundingCaseTypeMetaDataPass::$fundingCaseTypes as $fundingCaseType) {
      if (!isset($handlerServices[$fundingCaseType])) {
        ...
        Assert::keyExists($applicationProcessStatusDeterminerServices, $fundingCaseType);
        ...
        $handlerServices[$fundingCaseType] = $this->createFundingCaseTypeService(
          $container,
          $fundingCaseType,
          FundingCaseRejectHandler::class,
          [
            '$actionsDeterminer' => $actionsDeterminerServices[$fundingCaseType],
            '$applicationProcessStatusDeterminer' => $applicationProcessStatusDeterminerServices[$fundingCaseType],
    ...
    $container->register(
      FundingCaseRejectHandlerInterface::class,
      FundingCaseRejectHandlerCollector::class
