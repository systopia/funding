...
final class FundingProgramPermissionsSubscriber implements EventSubscriberInterface {

  /**
   * @inheritDoc
   */
  public static function getSubscribedEvents(): array {
    return [FundingDAOGetEvent::getEventName('RemoteFundingProgram') => ['onGet', 100]];
  }

  public function onGet(FundingDAOGetEvent $event): void {
