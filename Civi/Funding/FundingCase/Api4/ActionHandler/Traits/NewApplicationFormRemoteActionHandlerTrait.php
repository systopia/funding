...
namespace Civi\Funding\FundingCase\Api4\ActionHandler\Traits;
...
trait NewApplicationFormRemoteActionHandlerTrait {

  protected FundingCaseTypeProgramRelationChecker $relationChecker;
