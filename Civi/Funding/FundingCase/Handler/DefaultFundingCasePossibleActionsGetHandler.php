 ...
 * @codeCoverageIgnore
 */
final class DefaultFundingCasePossibleActionsGetHandler implements FundingCasePossibleActionsGetHandlerInterface {
  ...
  public function handle(FundingCasePossibleActionsGetCommand $command): array {
    return $this->serviceLocatorContainer->get($command->getFundingCaseType()->getName())
      ->getFundingCasePossibleActionsGetHandler()->handle($command);
  }
