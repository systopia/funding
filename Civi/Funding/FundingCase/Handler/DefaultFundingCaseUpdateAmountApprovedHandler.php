 ...
 * @codeCoverageIgnore
 */
final class DefaultFundingCaseUpdateAmountApprovedHandler implements FundingCaseUpdateAmountApprovedHandlerInterface {
  ...
  public function handle(FundingCaseUpdateAmountApprovedCommand $command): void {
    $this->serviceLocatorContainer->get($command->getFundingCaseType()->getName())
      ->getFundingCaseUpdateAmountApprovedHandler()->handle($command);
  }
