 ...
 * @codeCoverageIgnore
 */
final class DefaultTransferContractRecreateHandler implements TransferContractRecreateHandlerInterface {
  ...
  public function handle(TransferContractRecreateCommand $command): void {
    $this->serviceLocatorContainer->get($command->getFundingCaseType()->getName())
      ->getTransferContractRecreateHandler()->handle($command);
  }
