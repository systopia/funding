...
namespace Civi\Funding\FundingCaseTypes\AdB\IJB\Report\UiSchema;
...
final class IJBZuschussGroup extends JsonFormsGroup {

  public function __construct(
    string $currency,
    string $zuschussScopePrefix,
    string $grunddatenScopePrefix
  ) {
...
EOD,
            AdbIJBZuschussJsonSchema::TEILNEHMER_FESTBETRAG_FACHKRAEFTE,
            AdbIJBZuschussJsonSchema::TEILNEHMER_FESTBETRAG_JUGENDLICHE,
          ),
          'text/html',
      ...
      new JsonFormsGroup('Honorarkosten', [
        new JsonFormsMarkup(
          sprintf(
            ...
            AdbIJBZuschussJsonSchema::HONORARKOSTEN_FESTBETRAG,
            $currency,
          ),
          'text/html',
          ['rule' => $deutschlandRule]
...
EOD,
            str_replace('.', ',', (string) AdbIJBZuschussJsonSchema::FAHRTKOSTEN_FESTBETRAG_AUSLAND_EUROPA),
            str_replace('.', ',', (string) AdbIJBZuschussJsonSchema::FAHRTKOSTEN_FESTBETRAG_NICHT_EUROPA),
          ),
          'text/html',
...
pro TN, bis max. %s $currency pro Maßnahme beantragt werden.</p>
EOD,
          AdbIJBZuschussJsonSchema::ZUSCHLAG_FESTBETRAG_FACHKRAEFTE,
          AdbIJBZuschussJsonSchema::ZUSCHLAG_MAX_FACHKRAEFTE,
          AdbIJBZuschussJsonSchema::ZUSCHLAG_FESTBETRAG_JUGENDLICHE,
          AdbIJBZuschussJsonSchema::ZUSCHLAG_MAX_JUGENDLICHE,
        )
      ),
