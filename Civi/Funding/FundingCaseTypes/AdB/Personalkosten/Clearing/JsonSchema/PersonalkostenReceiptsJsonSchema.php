...
namespace Civi\Funding\FundingCaseTypes\AdB\Personalkosten\Clearing\JsonSchema;
...
final class PersonalkostenReceiptsJsonSchema extends JsonSchemaObject {
  ...
  public function __construct(
    ...
    $foerderquote = $clearingProcessBundle->getFundingProgram()->get('funding_program_adb.foerderquote');
    $properties = [
