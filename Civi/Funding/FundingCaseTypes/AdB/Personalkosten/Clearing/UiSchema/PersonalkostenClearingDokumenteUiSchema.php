...
namespace Civi\Funding\FundingCaseTypes\AdB\Personalkosten\Clearing\UiSchema;
...
final class PersonalkostenClearingDokumenteUiSchema extends JsonFormsCategory {

  public function __construct(string $arrayScope = '#/properties/dokumente') {
