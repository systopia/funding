    ...
    parent::__construct([
      'reportData' => new JsonSchemaObject([
        ...
        'teilnehmende' => new JsonSchemaObject([
          'alterUnter6' => new JsonSchemaInteger(['minValue' => 0]),
          'alter6bis12' => new JsonSchemaInteger(['minValue' => 0]),
          'alter13bis19' => new JsonSchemaInteger(['minValue' => 0]),
          'alter20bis29' => new JsonSchemaInteger(['minValue' => 0]),
          'alter30bis49' => new JsonSchemaInteger(['minValue' => 0]),
          'alter50bis66' => new JsonSchemaInteger(['minValue' => 0]),
          'alterAb67' => new JsonSchemaInteger(['minValue' => 0]),
