...
namespace Civi\Funding\FundingCaseTypes\DVV\IJB\Report;
...
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\JsonSchema\IJBGrunddatenJsonSchema;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\JsonSchema\IJBTeilnehmerJsonSchema;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\JsonSchema\DvvIJBZuschussJsonSchema;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\UiSchema\IJBGrunddatenUiSchema;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\UiSchema\IJBTeilnehmerUiSchema;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Report\JsonSchema\IJBDokumenteJsonSchema;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Report\JsonSchema\IJBFoerderungJsonSchema;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Report\JsonSchema\IJBSachberichtJsonSchema;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Report\UiSchema\IJBDokumenteCategory;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Report\UiSchema\IJBFoerderungGroup;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Report\UiSchema\IJBSachberichtCategory;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Report\UiSchema\IJBZuschussGroup;
...
final class IJBReportFormFactory implements ReportFormFactoryInterface {
  ...
  public function doCreateReportForm(FundingProgramEntity $fundingProgram): ReportFormInterface {
    ...
    $zuschussJsonSchema = new DvvIJBZuschussJsonSchema(TRUE);
