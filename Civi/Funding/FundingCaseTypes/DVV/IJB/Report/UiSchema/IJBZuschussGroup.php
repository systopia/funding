...
namespace Civi\Funding\FundingCaseTypes\DVV\IJB\Report\UiSchema;
...
EOD,
            DvvIJBZuschussJsonSchema::TEILNEHMER_FESTBETRAG_FACHKRAEFTE,
            DvvIJBZuschussJsonSchema::TEILNEHMER_FESTBETRAG_JUGENDLICHE,
          ),
          'text/html',
      ...
      new JsonFormsGroup('Honorarkosten', [
        new JsonFormsMarkup(
          sprintf(
            ...
            DvvIJBZuschussJsonSchema::HONORARKOSTEN_FESTBETRAG,
            $currency,
          ),
          'text/html',
          ['rule' => $deutschlandRule]
...
EOD,
            str_replace('.', ',', (string) DvvIJBZuschussJsonSchema::FAHRTKOSTEN_FESTBETRAG_AUSLAND_EUROPA),
            str_replace('.', ',', (string) DvvIJBZuschussJsonSchema::FAHRTKOSTEN_FESTBETRAG_NICHT_EUROPA),
          ),
          'text/html',
...
pro TN, bis max. %s $currency pro Maßnahme beantragt werden.</p>
EOD,
          DvvIJBZuschussJsonSchema::ZUSCHLAG_FESTBETRAG_FACHKRAEFTE,
          DvvIJBZuschussJsonSchema::ZUSCHLAG_MAX_FACHKRAEFTE,
          DvvIJBZuschussJsonSchema::ZUSCHLAG_FESTBETRAG_JUGENDLICHE,
          DvvIJBZuschussJsonSchema::ZUSCHLAG_MAX_JUGENDLICHE,
        )
      ),
