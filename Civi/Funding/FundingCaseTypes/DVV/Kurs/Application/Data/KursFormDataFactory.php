...
namespace Civi\Funding\FundingCaseTypes\DVV\Kurs\Application\Data;
...
final class KursFormDataFactory implements ApplicationFormDataFactoryInterface {

  use KursSupportedFundingCaseTypesTrait;

  public function __construct(
    private readonly KursProjektunterlagenFactory $kursProjektunterlagenFactory
  ) {}
  ...
  public function createFormData(ApplicationProcessEntity $applicationProcess, FundingCaseEntity $fundingCase): array {
    ...
    $data['projektunterlagen'] = $this->kursProjektunterlagenFactory->createProjektunterlagen($applicationProcess);
