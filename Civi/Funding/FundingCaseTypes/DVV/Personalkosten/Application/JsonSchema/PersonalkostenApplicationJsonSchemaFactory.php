...
namespace Civi\Funding\FundingCaseTypes\DVV\Personalkosten\Application\JsonSchema;
...
final class PersonalkostenApplicationJsonSchemaFactory implements NonCombinedApplicationJsonSchemaFactoryInterface {
  ...
  public function createJsonSchemaExisting(
    ...
    // @phpstan-ignore argument.type
      $fundingProgram->get('funding_program_dvv.foerderquote'),
      // @phpstan-ignore argument.type
      $fundingProgram->get('funding_program_dvv.sachkostenpauschale'),
