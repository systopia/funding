...
namespace Civi\Funding\FundingCaseTypes\DVV\Personalkosten\Clearing\JsonSchema;
...
final class PersonalkostenReceiptsJsonSchema extends JsonSchemaObject {
  ...
  public function __construct(
    ...
    $foerderquote = $clearingProcessBundle->getFundingProgram()->get('funding_program_dvv.foerderquote');
    $properties = [
