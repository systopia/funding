...
namespace Civi\Funding\FundingCaseTypes\DVV\Traits\Task;

use Civi\Funding\Entity\ApplicationProcessEntity;
use Civi\Funding\Entity\ApplicationProcessEntityBundle;
use Civi\Funding\Entity\FundingTaskEntity;

trait DVVClearingTaskModifyDueDateTrait {
  ...
  protected function getDueDate(
    ...
    return $applicationProcessBundle->getApplicationProcess()->getEndDate()
      ?->add(new \DateInterval(DVVClearingTaskConstants::DUE_DATE_DELAY));
  }
