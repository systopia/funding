...
use Civi\Funding\Task\Handler\FundingCaseTaskHandlerInterface;

/**
 * Should be combined with:
 * @see \Civi\Funding\PayoutProcess\Task\AbstractDrawdownCreateTaskCreator
 */
abstract class AbstractDrawdownCreateTaskHandler implements FundingCaseTaskHandlerInterface {
   ...
   * @inheritDoc
   *
   * @return \Civi\Funding\ActivityTypeNames::DRAWDOWN_TASK
   */
  ...
  public function modifyTask(
    ...
    if ($fundingCase->getAmountApproved() < $previousFundingCase->getAmountApproved()) {
      $payoutProcess = $this->payoutProcessManager->getLastByFundingCaseId($fundingCase->getId());
