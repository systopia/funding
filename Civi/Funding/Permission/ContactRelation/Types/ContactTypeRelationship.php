...
final class ContactTypeRelationship extends AbstractRelationType {

  public const NAME = 'ContactTypeRelationship';
  ...
  public function getLabel(): string {
    return E::ts('Relationship to contact of specific type');
  }
...
TEMPLATE;
  ...
  public function getHelp(): string {
    return E::ts(<<<HELP
Matches a contact that has a relationship of the specified type to a contact of
the specified type.
HELP);
  }
