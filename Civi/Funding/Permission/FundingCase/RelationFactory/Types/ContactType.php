 ...
 * @codeCoverageIgnore
 */
final class ContactType extends AbstractRelationPropertiesFactoryType {
...
TEMPLATE;
  ...
  public function getHelp(): string {
    return E::ts(<<<HELP
Assign permissions for new funding cases to contacts with the specified contact type.
HELP);
  }
