 ...
 * @codeCoverageIgnore
 */
final class RecipientContactRelationship extends AbstractRelationPropertiesFactoryType {

  public const NAME = 'RecipientContactRelationship';
  ...
  public function getLabel(): string {
    return E::ts('Relationship to recipient contact');
  }
