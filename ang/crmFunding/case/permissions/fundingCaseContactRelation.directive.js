 ...
 */
fundingModule.directive('fundingCaseContactRelation', ['$compile', function($compile) {
  return {
    restrict: 'E',
    scope: {
    ...
    templateUrl: '~/crmFunding/case/permissions/fundingCaseContactRelation.template.html',
