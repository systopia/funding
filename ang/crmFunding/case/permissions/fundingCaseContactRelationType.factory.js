...
/**
 * Defines a service factory to access funding case contact relation types via
 * CiviCRM APIv4.
 *
 ...
 */
fundingModule.factory('fundingCaseContactRelationTypeService', ['crmApi4', function(crmApi4) {
  return {
    /**
     * @returns {Promise<ContactRelationType[]>}
     */
    getAll: () => crmApi4('FundingCaseContactRelationType', 'get', {orderBy: {label: 'ASC'}}, 'name'),
  };
}]);
