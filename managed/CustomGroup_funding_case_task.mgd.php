...
return [
  ...
  [
    'name' => 'CustomGroup_funding_case_task_CustomField_external_url',
    'entity' => 'CustomField',
    'cleanup' => 'always',
    'update' => 'unmodified',
    'params' => [
      ...
      'values' => [
        ...
        'help_post' => E::ts('URL to an external system to fulfil the task.'),
        'html_type' => 'Text',
        'is_required' => FALSE,
        'text_length' => 255,
        'note_columns' => 60,
  ...
  [
    'name' => 'CustomGroup_funding_case_task_CustomField_external_url_label',
    'entity' => 'CustomField',
    'cleanup' => 'always',
    'update' => 'unmodified',
    'params' => [
      ...
      'values' => [
        ...
        'label' => E::ts('External URL Label'),
        'help_post' => E::ts('Label for the external URL.'),
        'html_type' => 'Text',
        'is_required' => FALSE,
        'text_length' => 255,
        'note_columns' => 60,
        'note_rows' => 4,
        'column_name' => 'external_url_label',
      ],
      'match' => [
        'name',
        'custom_group_id',
