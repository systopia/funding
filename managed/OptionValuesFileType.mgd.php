...
return [
  ...
  [
    'name' => 'OptionValue_file_type.payback_claim',
    'entity' => 'OptionValue',
    'cleanup' => 'unused',
    'update' => 'always',
    'params' => [
      ...
      'values' => [
        'option_group_id.name' => 'file_type',
        'label' => E::ts('Payback Claim'),
        'name' => FileTypeNames::PAYBACK_CLAIM,
        'grouping' => 'funding',
        'filter' => 0,
        'is_default' => FALSE,
        'weight' => 1,
  ...
  [
    'name' => 'OptionValue_file_type.payback_claim_template',
    'entity' => 'OptionValue',
    'cleanup' => 'unused',
    'update' => 'always',
    'params' => [
      ...
      'values' => [
        'option_group_id.name' => 'file_type',
        'label' => E::ts('Payback Claim Template'),
        'name' => FileTypeNames::PAYBACK_CLAIM_TEMPLATE,
        'grouping' => 'funding',
        'filter' => 0,
        'is_default' => FALSE,
        'weight' => 1,
