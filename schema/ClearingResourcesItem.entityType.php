...
return [
  'name' => 'FundingClearingResourcesItem',
  'table' => 'civicrm_funding_clearing_resources_item',
  'class' => 'CRM_Funding_DAO_ClearingResourcesItem',
  'getInfo' => fn() => [
    'title' => E::ts('Clearing Resources Item'),
    'title_plural' => E::ts('Clearing Resources Items'),
    'description' => E::ts('Clearing for an application resources item'),
    'log' => TRUE,
  ],
  'getFields' => fn() => [
    'id' => [
    ...
    'status' => [
      ...
      'required' => TRUE,
      'pseudoconstant' => [
        'callback' => [FundingPseudoConstants::class, 'getClearingItemStatus'],
      ],
    ],
    'file_id' => [
      'title' => E::ts('File ID'),
