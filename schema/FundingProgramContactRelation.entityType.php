...
return [
  ...
  'getInfo' => fn() => [
    'title' => E::ts('Funding Program Contact Relation'),
    'title_plural' => E::ts('Funding Program Contact Relations'),
    'description' => E::ts('Defines who is allowed to access a funding program'),
    'log' => TRUE,
  ],
  'getFields' => fn() => [
    'id' => [
      ...
      'input_type' => 'Number',
      'required' => TRUE,
      'description' => E::ts('Unique FundingProgramContactRelation ID'),
      'primary_key' => TRUE,
      'auto_increment' => TRUE,
    ],
    'funding_program_id' => [
