...
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\Application\Actions\KursApplicationActionsDeterminer;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\Application\Actions\KursApplicationStatusDeterminer;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\Application\Data\KursApplicationFormDataFactory;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\Application\Data\KursApplicationFormFilesFactory;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\Application\JsonSchema\KursApplicationJsonSchemaFactory;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\Application\UiSchema\KursApplicationUiSchemaFactory;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\EventSubscriber\KursApplicationStatusSubscriber;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\FundingCase\Actions\KursCaseActionsDeterminer;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\FundingCase\Data\KursCaseFormDataFactory;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\FundingCase\JsonSchema\KursCaseJsonSchemaFactory;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\FundingCase\UiSchema\KursCaseUiSchemaFactory;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\FundingCase\Validation\KursCaseValidator;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\KursMetaData;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\Report\KursReportDataLoader;
use Civi\Funding\FundingCaseTypes\AdB\SammelantragKurs\Report\KursReportFormFactory;
...
TaskServiceRegistrator::autowireAll(
  $container,
  __DIR__ . '/../Civi/Funding/FundingCaseTypes/AdB/SammelantragKurs/Task',
  'Civi\\Funding\\FundingCaseTypes\\AdB\\SammelantragKurs\\Task'
);
