...
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\Actions\IJBApplicationActionsDeterminer;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\Actions\IJBApplicationStatusDeterminer;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\Data\IJBApplicationFormDataFactory;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\Data\IJBApplicationFormFilesFactory;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\Data\IJBProjektunterlagenFactory;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\JsonSchema\IJBApplicationJsonSchemaFactory;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Application\UiSchema\IJBApplicationUiSchemaFactory;
use Civi\Funding\FundingCaseTypes\DVV\IJB\FundingCase\Actions\IJBCaseActionsDeterminer;
use Civi\Funding\FundingCaseTypes\DVV\IJB\IJBMetaData;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Report\IJBReportDataLoader;
use Civi\Funding\FundingCaseTypes\DVV\IJB\Report\IJBReportFormFactory;
...
TaskServiceRegistrator::autowireAll(
  $container,
  __DIR__ . '/../Civi/Funding/FundingCaseTypes/DVV/IJB/Task',
  'Civi\\Funding\\FundingCaseTypes\\DVV\\IJB\\Task'
);
