...
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\Application\Actions\KursApplicationActionsDeterminer;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\Application\Actions\KursApplicationStatusDeterminer;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\Application\Data\KursApplicationFormDataFactory;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\Application\Data\KursApplicationFormFilesFactory;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\Application\JsonSchema\KursApplicationJsonSchemaFactory;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\Application\UiSchema\KursApplicationUiSchemaFactory;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\EventSubscriber\KursApplicationStatusSubscriber;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\FundingCase\Actions\KursCaseActionsDeterminer;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\FundingCase\Data\KursCaseFormDataFactory;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\FundingCase\JsonSchema\KursCaseJsonSchemaFactory;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\FundingCase\UiSchema\KursCaseUiSchemaFactory;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\FundingCase\Validation\KursCaseValidator;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\KursMetaData;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\Report\KursReportDataLoader;
use Civi\Funding\FundingCaseTypes\DVV\SammelantragKurs\Report\KursReportFormFactory;
...
TaskServiceRegistrator::autowireAll(
  $container,
  __DIR__ . '/../Civi/Funding/FundingCaseTypes/DVV/SammelantragKurs/Task',
  'Civi\\Funding\\FundingCaseTypes\\DVV\\SammelantragKurs\\Task'
);
