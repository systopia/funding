...
use Civi\Funding\SammelantragKurs\Application\Data\KursApplicationCostItemsFactory;
...
$container->autowire(KursApplicationCostItemsFactory::class)
  ->addTag(KursApplicationCostItemsFactory::SERVICE_TAG);
