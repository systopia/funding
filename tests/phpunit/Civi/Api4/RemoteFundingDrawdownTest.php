...
final class RemoteFundingDrawdownTest extends AbstractRemoteFundingHeadlessTestCase {
  ...
  public function testCreate(): void {
    ...
    $drawdown = RemoteFundingDrawdown::get()
      ->setRemoteContactId((string) $contact['id'])
      ->addSelect('id', 'status', 'amount', 'amount_accepted', 'amount_paid_out', 'amount_new')
      ->execute()->single();
    static::assertEquals([
      'id' => $record['id'],
      'status' => 'new',
  ...
  public function testGetFields(): void {
    static::assertCount(18, RemoteFundingDrawdown::getFields()->execute());
  }
