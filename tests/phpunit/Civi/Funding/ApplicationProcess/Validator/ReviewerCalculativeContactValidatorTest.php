...
/**
 * @covers \Civi\Funding\ApplicationProcess\Validator\ReviewerCalculativeContactValidator
 */
final class ReviewerCalculativeContactValidatorTest extends TestCase {
  ...
  private ReviewerCalculativeContactValidator $validator;
  ...
  protected function setUp(): void {
    ...
    $this->validator = new ReviewerCalculativeContactValidator(
  ...
  public function testValidateContactNotAllowed(): void {
    ...
    static::assertEquals([
      'reviewer_calc_contact_id' => [
        ...
        'reviewer_calc_contact_id',
        'Contact 2 is not allowed as calculative reviewer.'),
      ],
    ], $result->getErrors());
  }
  ...
  public function testValidateNewContactNotAllowed(): void {
    ...
    static::assertEquals([
      'reviewer_calc_contact_id' => [
        EntityValidationError::new(
        'reviewer_calc_contact_id',
        'Contact 1 is not allowed as calculative reviewer.'),
      ],
    ], $result->getErrors());
  }
