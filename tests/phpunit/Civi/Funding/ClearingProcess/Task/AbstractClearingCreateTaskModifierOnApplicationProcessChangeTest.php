...
/**
 * @covers \Civi\Funding\ClearingProcess\Task\AbstractClearingCreateTaskModifierOnApplicationProcessChange
 */
final class AbstractClearingCreateTaskModifierOnApplicationProcessChangeTest extends TestCase {

  private AbstractClearingCreateTaskModifierOnApplicationProcessChange $taskModifier;

  protected function setUp(): void {
    parent::setUp();
    $this->taskModifier = new class() extends AbstractClearingCreateTaskModifierOnApplicationProcessChange {
