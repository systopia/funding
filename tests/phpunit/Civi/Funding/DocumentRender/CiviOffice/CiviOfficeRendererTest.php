...
/**
 * @covers \Civi\Funding\DocumentRender\CiviOffice\CiviOfficeRenderer
 *
 * @group headless
 */
final class CiviOfficeRendererTest extends AbstractFundingHeadlessTestCase {
...
EOT
  ...
  public function testGetMimeType(): void {
    static::assertSame('application/pdf', $this->renderer->getMimeType());
  }
  ...
  public function testRender(): void {
    ...
    $filename = $this->renderer->render(
      'file://' . E::path('tests/phpunit/resources/FundingCaseDocumentTemplate.docx'),
      'TransferContract',
      $fundingCase->getId(),
      [
