...
/**
 * @covers \Civi\Funding\EventSubscriber\ClearingProcess\ClearingProcessReopenSubscriber
 */
final class ClearingProcessReopenSubscriberTest extends TestCase {
  ...
  private ClearingProcessReopenSubscriber $subscriber;
  ...
  protected function setUp(): void {
    ...
    $this->subscriber = new ClearingProcessReopenSubscriber(
  ...
  public function testReopened(): void {
    ...
    $this->clearingCostItemManagerMock->expects(static::once())->method('resetAmountsAdmittedByClearingProcessId')
      ->with($clearingProcessBundle->getClearingProcess()->getId());
    $this->clearingResourcesItemManagerMock->expects(static::once())->method('resetAmountsAdmittedByClearingProcessId')
      ->with($clearingProcessBundle->getClearingProcess()->getId());
  ...
  public function testNotReopened(): void {
    ...
    $this->clearingCostItemManagerMock->expects(static::never())->method('resetAmountsAdmittedByClearingProcessId');
