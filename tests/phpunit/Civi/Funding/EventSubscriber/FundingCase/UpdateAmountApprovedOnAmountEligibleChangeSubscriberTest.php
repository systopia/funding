...
/**
 * @covers \Civi\Funding\EventSubscriber\FundingCase\UpdateAmountApprovedOnAmountEligibleChangeSubscriber
 */
final class UpdateAmountApprovedOnAmountEligibleChangeSubscriberTest extends TestCase {
  ...
  private UpdateAmountApprovedOnAmountEligibleChangeSubscriber $subscriber;
  ...
  protected function setUp(): void {
    ...
    $this->metaDataMock->autoUpdateAmountApproved = AutoUpdateAmountApproved::OnAmountEligibleChange;
    $this->updateAmountApprovedHandlerMock = $this->createMock(FundingCaseUpdateAmountApprovedHandlerInterface::class);
    $this->subscriber = new UpdateAmountApprovedOnAmountEligibleChangeSubscriber(
