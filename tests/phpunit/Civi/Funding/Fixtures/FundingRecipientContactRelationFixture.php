...
final class FundingRecipientContactRelationFixture {
   ...
   */
  public static function addFixture(int $fundingProgramId, string $type, array $properties): array {
    return FundingRecipientContactRelation::create(FALSE)
      ->setValues([
