...
namespace Civi\Funding\FundingCaseTypes\DVV\SonstigeAktivitaet\JsonSchema;
...
use Civi\Funding\FundingCaseTypes\DVV\SonstigeAktivitaet\Application\JsonSchema\AVK1JsonSchema;
...
/**
 * @covers \Civi\Funding\FundingCaseTypes\DVV\SonstigeAktivitaet\Application\JsonSchema\AVK1JsonSchema
 */
class AVK1JsonSchemaTest extends TestCase {
  ...
  public function testJsonSchema(): void {
    ...
    $spenden = 3.0;
    $eigenanteil = 100.00 + 10.00 + $spenden;
    static::assertSame($eigenanteil, $resultData->finanzierung->eigenanteil);
    $gesamtmittel = $eigenanteil + $oeffentlicheMittelGesamt;
  ...
  public function testTooLessEquity(): void {
    $possibleRecipients = [
      1 => 'Organization 1',
      2 => 'Organization 2',
    ];
    ...
    $result = $this->validator->validate($jsonSchema, $data);
    static::assertSame(
      ['/finanzierung/eigenanteil' => ['Der Eigenanteil muss mindestens 10 % betragen.']],
