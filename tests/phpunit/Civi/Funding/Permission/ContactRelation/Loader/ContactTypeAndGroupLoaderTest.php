...
/**
 * @covers \Civi\Funding\Permission\ContactRelation\Loader\ContactTypeAndGroupLoader
 *
 * @group headless
 */
final class ContactTypeAndGroupLoaderTest extends AbstractFundingHeadlessTestCase {
  ...
  public function testGetContacts(): void {
    ...
    ], $this->loader->getContacts('ContactTypeAndGroup', [
    ...
    static::assertEmpty($this->loader->getContacts('ContactTypeAndGroup', [
