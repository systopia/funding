...
/**
 * @covers \Civi\Funding\SonstigeAktivitaet\Application\Data\AVK1ApplicationCostItemsFactory
 */
  ...
  public function testCreateItems(): void {
    $expectedItems = [
      ...
      ApplicationCostItemEntity::fromArray([
        ...
        'amount' => 12.34,
        'properties' => ['zweck' => 'Sonstige Ausgabe 1'],
      ]),
      ApplicationCostItemEntity::fromArray([
        'application_process_id' => 2,
        'identifier' => 's2',
        'type' => 'sonstigeAusgabe',
        'amount' => 56.78,
        'properties' => ['zweck' => 'Sonstige Ausgabe 2'],
      ]),
      ApplicationCostItemEntity::fromArray([
        'application_process_id' => 2,
